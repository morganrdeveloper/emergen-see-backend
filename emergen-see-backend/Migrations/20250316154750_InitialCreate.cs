    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TriageForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TriageForms_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TriageForms_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TriageForms_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_QueueId",
                table: "Patients",
                column: "QueueId");

            migrationBuilder.CreateIndex(
                name: "IX_TriageForms_DoctorId",
                table: "TriageForms",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_TriageForms_NurseId",
                table: "TriageForms",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_TriageForms_PatientId",
                table: "TriageForms",
                column: "PatientId",
                unique: true);
        }
